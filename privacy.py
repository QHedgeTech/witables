...
<div class="jumbotron">
  <h1>Privacy</h1>
  <h2>Be careful with your data!</h2>
  <p>WiTables works as web-service. Be carefull to restrain access to your server. It is important to remind that once the service is online anybody could see your data.</p>
